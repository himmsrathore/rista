...
if($check1[0]=='upgraded' and $check1[1]=='bronze')
{
...
<?php
     if($check1[0]=='' or $left_days<=0){

?><table width="519" height="370" align="center" >
  <tr height="40">
    <td height="105" colspan="2">

<font color="#FF3F55" size="+2">UPGRADE TO BRONZE </font><font color="#2A3F55">(1100 RS. For Three Months)</font></td>
  </tr>
<tr><td width="90" height="45"><font color="red">1.&nbsp;&nbsp;&nbsp;&nbsp;</font></td>
<td width="417"><font color="#2A3F55">3000 Messages</font></td>
</tr>
<tr><td height="45"><font color="red">2.&nbsp;&nbsp;&nbsp;&nbsp;</font></td>
<td><font color="#2A3F55">300 Expression Messages</font></td>
</tr>
<tr><td height="45"><font color="red">3.&nbsp;&nbsp;&nbsp;&nbsp;</font></td>
<td><font color="#2A3F55">40  Mobile No. View</font></td>
</tr>
<tr><td height="45"><font color="red">4.&nbsp;&nbsp;&nbsp;&nbsp;</font></td>
<td><font color="#2A3F55">Free Live Chat</font></td></tr>
<tr><td height="69" colspan="2" align="center"><A href="upgrade_bronze.php"><font color="#000000">UPGRADE</font></A></td>
</tr>
...
<?
	 ...
	 ?><table width="999"><tr>
  <td height="59" align="center"><font color="#FF0000" size="4" face="vardana">You Are Currently Using BRONZE Package</font></td><td width="250" align="right"><a href="user_chat.php" style="text-decoration:none;"><img src="../images/chat.png" width="95" height="84" style="border:none;" title="Chat"/></a></td>
  <td width="41"></td>
</tr>
  <tr><td width="692" height="300" align="center" valign="top"> <table><form name="search" method="post" action="upgrade_to_bronze.php" enctype="multipart/form-data"><tr><td height="63" width="97" align="left"><b><font face="Verdana" size="2" color="#003300">Looking For 
             : </font> </b> </td>
		   ...
		   <tr><td colspan="7" align="center"><table width="602" height="134">
		     <tr align="center"><TD height="59" colspan='3' align='center' class=tblcell1  style="background:url(../images/bb.png) 0 0 no-repeat; width:373px; height:33px; background-position:center;">
...
<TR class=tblrow>
  ...
  <td valign="top" colspan="2">
	...
	<tr align=left><td height="23"><font  size="2" face="Verdana">&nbsp;&nbsp;&nbsp;Unlimited messages.</font> </td>
		</tr>
				 
				 
	<tr>
			 
           <td width="274" height="46" align=left><font   size="2" face="Verdana">&nbsp;&nbsp;&nbsp;Unlimited Expression Messages.</font> </td>
			
		      </tr><tr>
					 
									<td height="23" align=left><font   size="2" face="Verdana">&nbsp;&nbsp;&nbsp;Unlimited Mobile No. View.</font> </td>
		</tr><tr>
					 
									<td height="23" align=left><font   size="2" face="Verdana">&nbsp;&nbsp;&nbsp;Free Live Chat.</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php
$check_up=mysql_query("select * from user_upgrade where username='$username'");
$check_up1=mysql_fetch_array($check_up);
if($check_up1[0]==NULL){
echo "<A href='upgrade_to_gold.php?up=ul'><img src='../images/ok.gif' border=none></A></td>";
}
else if($check_up1[8]=='gold'){
echo "<A href='cancil_upgrade.php'><img src='../images/cancel.gif' border=none></A></td>";
}
?></td>
	...
	<tr align=left><td><font  size="2" face="Verdana">&nbsp;&nbsp;&nbsp;Unlimited messages.</font> </td>
		</tr>
				 
				 
	<tr>
			 
           <td width="274" height="46" align=left size="2" face="Verdana"><font   size="2" face="Verdana">&nbsp;&nbsp;&nbsp;Unlimited Expression Messages.</font> </td>
			
		      </tr><tr>
					 
									<td align=left><font   size="2" face="Verdana">&nbsp;&nbsp;&nbsp;60  Mobile No. View.</font> </td>
		</tr><tr>
					 
									<td height="28" align=left><font   size="2" face="Verdana">&nbsp;&nbsp;&nbsp;Free Live Chat.</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php
$check_up=mysql_query("select * from user_upgrade where username='$username'");
$check_up1=mysql_fetch_array($check_up);
if($check_up1[0]==NULL){
echo "<A href='upgrade_to_silver.php?up=ul'><img src='../images/ok.gif' border=none></A></td>";
}
else  if($check_up1[8]=='silver'){
echo "<A href='cancil_upgrade.php'><img src='../images/cancel.gif' border=none></A></td>";
}
?> </td>
		</tr></table><br /><table width="274" height="148" border="0" cellPadding="0" cellSpacing="0" style="background:url(../images/conten.png) 0 0 no-repeat;" >
	...
	<tr align=left>
	  <td><font  size="2" face="Verdana">&nbsp;&nbsp;&nbsp;3000 messages.</font> </td>
		</tr>
				 
				 
	<tr>
			 
           <td width="274" height="46" align=left><font   size="2" face="Verdana">&nbsp;&nbsp;&nbsp;300 Expression Messages.</font> </td>
			
		      </tr><tr>
					 
									<td align=left><font   size="2" face="Verdana">&nbsp;&nbsp;&nbsp;40  Mobile No. View.</font> </td>
		</tr><tr>
					 
									<td height="28" align=left><font   size="2" face="Verdana">&nbsp;&nbsp;&nbsp;Free Live Chat.</font> </td>
...
<tr>
	  <td width="294" align="left"><a href="view_list.php"><font color="#808080" face="Verdana" size="2">Viewed Mobile No.</font></a>:&nbsp;<font color=red >
