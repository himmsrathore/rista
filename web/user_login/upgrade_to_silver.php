...
if($check1[0]=='upgraded' and $check1[1]=='silver')
{
...
if($check1[1]=='gold' and !isset($_GET['up'])){
...
<font color="#FF3F55" size="+2">UPGRADE TO SILVER </font><font color="#2A3F55">(1300 RS. For Three Months)</font></td>
  </tr>
...
<td><font color="#2A3F55">60  Mobile No. View</font></td>
</tr>
...
<?php
if(isset($_GET['up'])){
echo "<A href='upgrade_silver.php?up=ul'>";}
else{

echo "<A href='upgrade_silver.php'>";}


?>
<font >UPGRADE</font></A></td>
</tr>
...
<?
	 ...
	 ?><table width="999"><tr><td height="59"   align="center"><font color="#FF0000" size="+2" face="Algerian">You Are Currently Using Silver Package</font></td><td width="252" align="right"><a href="user_chat.php" style="text-decoration:none;"><img src="../images/chat.png" width="95" height="84" style="border:none;" title="Chat"/></a></td>
  <td width="41"></td>
</tr>
  <tr><td width="690" height="300" align="center" valign="top"> <table><form name="search" method="post" action="upgrade_to_silver.php" enctype="multipart/form-data"><tr><td height="63" width="97" align="left"><b><font face="Verdana" size="2" color="#003300">Looking For 
             : </font> </b> </td>
  ...
  <td valign="top" colspan="2">
	...
	<tr>
           ...
           <td width="274" height="46" align=left><font   face="Verdana" size="2">&nbsp;&nbsp;&nbsp;Unlimited Expression Messages.</font> </td>
									...
									<td height="23" align=left><font   face="Verdana" size="2">&nbsp;&nbsp;&nbsp;Free Live Chat.</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php
