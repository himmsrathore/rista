...
?>
	  <center>
	    ...
	    <br><br><br>
	  <form method="post" action="up_bronze.php"><table width="373" height="300" bgcolor="#E0D1BE" >
	      <tr>
...
<?
    ...
    if(($check1[0]=='upgraded') and ($chec1[0]=='gold')){
     ...
     if(($check1[0]=='upgraded') and ($chec1[0]=='silver')){
     ...
     if(($check1[0]=='upgraded') and ($chec1[0]=='bronze')){
