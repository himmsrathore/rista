...
?>
	  <center><font size='+2' color="#FF0000"><b>Upgrade To Gold</b></font><br><br><br>
	    <form method="post" action="<?php if(isset($_GET['up'])){echo "up_gold.php?up=ul";}else{echo "up_gold.php";} ?>">
		<table width="373" height="300" bgcolor="#E0D1BE" >
	      <tr>
