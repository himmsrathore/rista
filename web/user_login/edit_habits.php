...
<table width=1000 cellspacing="0" cellpadding="0" background="../images/main.jpg"><tr><td width="333"></td>
<td width="665">
<table border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<table width="92%" height="282" border="0" cellPadding="0" cellSpacing="0">
<form name="habits" id="habits" action="success_habits.php">						
	<tr>
						...
						<font face="Verdana" color="#FF0000">Edit Your Habits</font></b></td>
								</tr>
								<tr>
		...
		<select id="food" name="food" size="1" tabindex="1" style="font-weight: 700;color:#FFFFFF; background-color:#999999; width:200px;">
		<?php 
						if($row[27]!="")
						echo("<option selected value=$row[27]>$row[27]</option>");
						else
                  ...
                  <option value="Vegetarian">Vegetarian</option>
					<option value="Non-Vegiterian">Non-Vegiterian</option>
								...
								<tr>
						<td width="24%" height="26" align="left"><b>
						<font face="Verdana" size="2"  >Smoking
						</font></b></td>
						<td width="76%" height="26" align="left">
						<b>
						<font color="#333333" face="Verdana" size="2">
		<select id="smoking" name="smoking" size="1" tabindex="2" style="font-weight: 700;color:#FFFFFF; background-color:#999999; width:200px;">
		<?php 
						if($row[28]!="")
						echo("<option selected value=$row[28]>$row[28]</option>");
						else
						echo("<option selected value=None>Select</option>");
						?>
                  ...
                  <option value="Occasionally">Occasionally</option>
								...
								<tr>
						<td width="24%" height="26" align="left"><b>
						<font face="Verdana" size="2" >Drinking
						</font></b></td>
						<td width="76%" height="26" align="left">
						<b>
						<font color="#333333" face="Verdana" size="2">
		<select id="drinking" name="drinking" size="1" tabindex="3" style="font-weight: 700;color:#FFFFFF; background-color:#999999; width:200px;">
                  <?php 
						if($row[29]!="")
						echo("<option selected value=$row[29]>$row[29]</option>");
						else
						echo("<option selected value=None>Select</option>");
						?>
                  ...
                  <option value="Occasionally">Occasionally</option>
								...
								<tr>
									<td height="23" width="20%" align="left">&nbsp;</td>
									<td height="23" width="80%" align="left">&nbsp;									</td>
								</tr>
								<tr>
									<td height="26" width="20%" align="left">&nbsp;</td>
