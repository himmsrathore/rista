...
if(!$conn) die("Failed to connect to database!");
	...
	$sql = "SELECT * from interest WHERE username='".$username."' ORDER BY s_no DESC";
...
<table width=1000 cellspacing="0" cellpadding="0" background="../images/main.jpg"><tr><td valign="bottom" align="center">
<?php
if(isset($_GET['status'])){
    echo "<br><font color=gray>Your Intrest Successfully Expressed</font>";
}
...
<table border="0" width="989" cellspacing="0" cellpadding="0" height="257">
	...
	<tr>
								...
								<tr>
						<td width="24%" height="52" align="left" colspan="2"><b>
						<font face="Verdana" color="#FF0000">Interests Expressed:</font></b></td>
								</tr>
								<tr>
									...
									<table width="900" cellspacing="0" cellpadding="0" style="border: 1px solid #000000" >
											<tr>
												...
												Interest Received By</font></b></td>
												<td bgcolor="maroon" align="left"><b>
												<font face="Verdana" size="2" color="#FFFFFF">
												Message</font></b></td>
												<td width="15" bgcolor="maroon" align="left">&nbsp;
												</td>
	...
	while($row = mysql_fetch_assoc($rs)) 
    {
			...
			$result5 = queryselect("registeration_no,name","user_info","email = '".$row['user_email']."'",$link);
if(mysql_num_rows($result5)!=0)
{
 $row5 = mysql_fetch_row($result5); 
 $r_no = $row5[0];
 $name = $row5[1];
 $data=mysql_query("select image_url from user_info where registeration_no=$r_no");
 $data1=mysql_fetch_array($data);
									...
									<div align="center">
										<table width="900" cellspacing="0" cellpadding="0" style="border: 1px solid #000000; " bordercolor="#000000">
											<tr>
												<td width="271">
												<p align="left" style="text-decoration:none">&nbsp;&nbsp;<a href="view_user.php?no=<?php echo $r_no;?>" target="_blank" style="text-decoration:none"><b>
												<font face="Verdana" size="2" color=black><?php echo "<img src=../$data1[0] width=70 height=80 border=none title=$name>";?></font></b></a></td>
												<td>
												<p align="left"><b>
    ...
    $que=mysql_query($sql);
										...
										if($row1[0]==NULL){
										echo "<font color=red>No Interests Expressed</font>";
										}
