...
<div align="center">
  <table width=1000 height=350  cellspacing="0" cellpadding="0" >
    <tr><td></td></tr><tr>
      <td align="center">
	  <font size="+2" face="vardana" color="#FF0000"><b>Upgrade To Gold</b></font><br /><br /><br /><br />
	  <?
	  $i=$_POST['mathod'];
	  if($i=='cash'){
	     if(isset($_GET['up'])){
	  echo "<form method='post' action='upgrade_gold_s.php?type=cash&up=gold&upp=ul'><center>
	  ...
	  echo "<form method='post' action='upgrade_gold_s.php?type=cash&up=gold'>
	  		<center><font size='+2' >Administrators Address</font><br><br>
	  ...
	  if($i=='pick up'){
if(isset($_GET['up'])){
	  echo "<center><font size='+2' >Upgrade Using Pick Up</font><br><br><form method='post'  action='upgrade_gold_s.php?type=pup&up=gold&upp=ul'onsubmit='return check()' name=data>
	  ...
	  echo "<center><font size='+2' >Upgrade Using Pick Up</font><br><br><form method='post'  action='upgrade_gold_s.php?type=pup&up=gold'onsubmit='return check()' name=data>
	  	<font size='+2' >Please Enter Your Address</font></center><br><br>
		<center><table width=520 height=250><tr align=left><td  align=left>Your Mobile No.</td><td align=left><input type=text name=mob style='font-weight: 700; width:150px; color:#FFFFFF; background-color:#999999;'></td></tr>
		<tr><td align=lef>Your Address</td><td align=left><textarea name=address id=reason tabindex=1 rows='9' cols='46' style='background-color:#999999; color:#FFFFFF'></textarea></td></tr>
	  ...
	  if($i=='dd'){
	  if(isset($_GET['up'])){
	     echo "<font size='+2' >Upgrade Using DD</font><br><br><form method='post'  action='upgrade_gold_s.php?type=dd&up=gold&upp=ul'onsubmit='return check1()' name=data1>
	  	<br><br>
		...
		<tr><td><input type=submit value=Submit tabindex=2 style='background:url(../images/send.gif);width:81px; height:32px; color:#FFFFFF; border:none;'></td></tr></table></center>
	     ...
	     echo "<font size='+2' >Upgrade Using DD</font><br><br><form method='post'  action='upgrade_gold_s.php?type=dd&up=gold'onsubmit='return check1()' name=data1>
	  	<br><br>
		<center><table width=400 height=250 ><tr><td><font >Your DD No.</font></td><td><input type=text name=ddno style='font-weight: 700; width:150px; color:#FFFFFF; background-color:#999999;'></td></tr>
		<tr><td><font >Your Bank Name.</font></td><td><input type=text name=branch style='font-weight: 700; width:150px; color:#FFFFFF; background-color:#999999;'></td></tr>
		<tr><td><font >Date DD.</font></td><td><input type=text name=date style='font-weight: 700; width:150px; color:#FFFFFF; background-color:#999999;'></td></tr>
	  ...
	  if(isset($_GET['up'])){
	    ...
	    echo "<center><font size='+2' >Upgrade Using Debit Card</font><br><br><form method='post'  action='upgrade_gold_s.php?type=dabit&up=gold&upp=ul'><br><br>
		<FONT COLOR=RED><p>You can transfer money using Internet Banking to our Bank Account  and send mail at info@ristaa.com for confirmation. when your transfer completed. </P></font><br>  ( <font color=blue>Our Bank Account Details:</font><font color=red>BIS Software Dev. Pvt. Ltd.,HDFC ACC. NO.-06587239363</font> ) <br><br><br>
		<input type=submit value=Submit tabindex=2 style='background:url(../images/send.gif);width:81px; height:32px; color:#FFFFFF; border:none;'>
		
	  </form><br><br><br></center>";}
else{
echo "<center><font size='+2' >Upgrade Using Debit Card</font><br><br><form method='post'  action='upgrade_gold_s.php?type=dabit&up=gold'><br><br>
		<FONT COLOR=RED><p>You can transfer money using Internet Banking to our Bank Account  and send mail at info@ristaa.com for confirmation. when your transfer completed. </P></font><br>  ( <font color=blue>Our Bank Account Details:</font><font color=red>BIS Software Dev. Pvt. Ltd.,HDFC ACC. NO.-06587239363</font> ) <br><br><br>
		<input type=submit value=Submit tabindex=2 style='background:url(../images/send.gif);width:81px; height:32px; color:#FFFFFF; border:none;'>
