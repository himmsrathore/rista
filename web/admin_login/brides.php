...
<body>
	<table border="0" cellspacing="0" width="1468">
		<Tr  align="center">
			<Td colspan="2" width="1466">
		...
		<Tr>
			<Td height='24' align='right' width="1466" colspan="2"></td>
		</Tr>
		<tr align="center">
			...
			<td width="1173" valign="top">
				&nbsp;<table border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #93C9FF" width="1047" >
					<?php
          ...
          <TD class=tblcell1 bgcolor="#53BAFF" height="21" width="223"><b>
 ...
 <TD class=tblcell1 bgcolor="#53BAFF" height="28" width="254"><b>
          ...
          <TD class=tblcell1 bgcolor="#53BAFF" height="21" width="77">
